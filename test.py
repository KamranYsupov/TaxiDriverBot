...
class API2GisService:
    ...
    def __init__(self, api_key: str = os.getenv('API_2GIS_KEY')):
    ...
    def get_address(
        ...
        not_found_exc = API2GisError('Адрес не найден для данных координат')
...
from_address_input = 'Новосибирск, Ленина 12'# 'Астрахань, Николая Островского, 154к3'
from_lat, from_lot = 46.337495, 48.07203

print(from_lat, from_lot)
from_address = api_2gis_service.get_address(from_lat, from_lot, return_data=True)
print(from_address)